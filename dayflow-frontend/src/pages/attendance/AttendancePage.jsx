...
// Generate realistic mock attendance records for employee view if backend is empty
...
export default function AttendancePage() {
  ...
  return (
    <div className="space-y-6 pb-12">
      {/* ── Page Header matching Dayflow Uniform System ── */}
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button
            ...
            className={`flex items-center gap-2 rounded-xl px-4 py-2 text-xs font-semibold transition-all shadow-subtle ${
              isCheckedIn
          ...
          >
            ...
            <span>{isCheckedIn ? 'Check Out Today' : 'Check In Today'}</span>
          </button>

          {/* Admin / Employee Tab Controls matching TimeOffPage design */}
          {isAdminOrHR && (
      ...
      {activeTab === 'employee' && (
        <div className="space-y-6">
          {/* Subheader Controls & Uniform Summary Cards */}
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            {/* Uniform Summary Stat Cards (Matching Dayflow App Design System) */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div className="flex items-center gap-3 rounded-2xl border border-[#EAEAEC] bg-white p-4 shadow-subtle">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-[#059669]">{calculatedSummary.daysPresent}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 rounded-2xl border border-[#EAEAEC] bg-white p-4 shadow-subtle">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-[#2563EB]">{calculatedSummary.leavesTaken}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 rounded-2xl border border-[#EAEAEC] bg-white p-4 shadow-subtle">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-[#5B4FE9]">{calculatedSummary.totalWorkingDays}</p>
                </div>
              </div>
            </div>
          </div>

          {/* Table Container matching Dayflow Uniform Table Style */}
          <div className="overflow-hidden rounded-2xl border border-[#EAEAEC] bg-white shadow-subtle">
            <div className="border-b border-[#EAEAEC] bg-[#F8F9FA] px-6 py-3.5 flex items-center justify-between">
              ...
              <span className="text-xs text-[#6B6B76] font-medium">Standard 8h working hours (includes 1h break)</span>
            </div>
              ...
              <table className="w-full text-xs">
                ...
                <tbody className="divide-y divide-[#F1F1F4]">
                  {employeeDisplayRecords.map((r, i) => (
                    ...
                    >
                      <td className="px-6 py-3.5 font-semibold text-[#1A1A1F]">
                        {formatDateFormatted(r.date)} <span className="ml-1 text-[#6B6B76] font-normal">({getDayName(r.date)})</span>
                      </td>
                      <td className="px-6 py-3.5 font-mono text-[#1A1A1F]">{r.checkIn || '—'}</td>
                      <td className="px-6 py-3.5 font-mono text-[#1A1A1F]">
                        {r.checkOut || (r.status === 'Present' ? <span className="font-sans font-medium text-[#D97706]">Pending</span> : '—')}
                      </td>
                ...
                {adminDailyRows.length === 0 ? (
                  ...
                  adminDailyRows.map((row, i) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-3.5 font-mono text-[#1A1A1F]">{row.checkIn}</td>
                      <td className="px-6 py-3.5 font-mono text-[#1A1A1F]">{row.checkOut}</td>
