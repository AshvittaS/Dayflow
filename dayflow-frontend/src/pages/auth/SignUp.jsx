...
export default function SignUp() {
  ...
  function handleSubmit(e) {
    ...
    setPasswordError('')
    // TODO: wire to real signup call.
    // SKILL.md §1: this is the company/admin's first account — employees don't self-register.
    // Login ID is system-generated via generateLoginId() — not typed by the user.
    navigate('/signin')
  }
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col items-center justify-center bg-base-panel border-r border-base-border px-16 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          ...
          <p className="max-w-sm text-sm leading-relaxed text-slate-400">
            Create your company's admin account. After setup, you can add employees
            and configure payroll, attendance, and leave policies.
          </p>
          <div className="mt-10 rounded-xl border border-base-border bg-base-card p-5 text-left text-sm">
            ...
            {[
              ...
              'A unique Login ID is generated for you',
              'Add employees and configure their roles',
              'Set up payroll, leave, and attendance rules'
            ].map((step, i) => (
        ...
        <div className="w-full max-w-md">
          <div className="mb-8">
            ...
            <p className="mt-1 text-sm text-slate-400">
              Admin / HR Officer account for your company
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4" noValidate>
            ...
            <div>
              <label htmlFor="signupPassword" className="mb-1.5 block text-xs font-medium text-slate-300">Password</label>
            ...
            <div>
              <label htmlFor="signupConfirmPassword" className="mb-1.5 block text-xs font-medium text-slate-300">Confirm Password</label>
              <div className="relative">
                <input
                  ...
                  required
                  placeholder="••••••••"
                  className={`w-full rounded-lg border bg-base-card px-4 py-2.5 pr-10 text-sm text-white placeholder-slate-600 outline-none focus:ring-1 ${
                    passwordError
                      ? 'border-red-500/70 focus:border-red-500 focus:ring-red-500/20'
                      : 'border-base-border focus:border-accent focus:ring-accent/30'
                  }`}
                />
                <button
                  type="button"
              ...
              {passwordError && (
                <p role="alert" className="mt-1 text-xs text-red-400">{passwordError}</p>
              )}
            </div>
