...
export default function SignUp() {
  ...
  function handleSubmit(e) {
    ...
    if (!isCompanyValid) {
      setSubmitError('Please enter your official company or organization name.')
      return
    }
    if (!isNameValid) {
    ...
    if (strengthScore < 2) {
      setSubmitError('Please choose a stronger password (at least 8 characters with numbers or symbols).')
      return
    }
  ...
  return (
    <div className="flex min-h-screen bg-[#0b0c10] text-[#f8fafc]">
      {/* ── Left Hero Panel (Workweek & Living Cadence Visual) ── */}
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-6 py-10 lg:px-16 overflow-y-auto">
        ...
        <div className="mb-6 flex flex-col items-center text-center lg:hidden">
          <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-br from-[#ff6b4a] to-[#e85d3b] shadow-lg shadow-[#ff6b4a]/25 ring-1 ring-white/20">
            <svg
        ...
        <div className="w-full max-w-[460px]">
          ...
          {/* Form Header */}
          <div className="mb-5">
            <div className="inline-flex items-center gap-1.5 rounded-full border border-[#ff6b4a]/30 bg-[#ff6b4a]/10 px-2.5 py-0.5 font-mono text-[10px] font-semibold uppercase tracking-wider text-[#ff6b4a]">
          ...
          {/* Critical Framing Alert: Admin Only, Employees Don't Self-Register */}
          <div className="mb-5 rounded-xl border border-[#ff6b4a]/20 bg-[#ff6b4a]/5 p-3.5 text-xs text-[#d8dde6] leading-relaxed">
            <div className="flex items-start gap-2.5">
              <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-[#ff6b4a]/20 text-xs font-bold text-[#ff6b4a]">
                🛡️
              </span>
              <div>
                <span className="font-semibold text-white">Company Workspace Architecture: </span>
                This creates your master organization profile. Employees do not self-register — they will automatically receive auto-generated Login IDs once you onboard them.
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4" noValidate>
            ...
            <div>
              ...
              <div className="flex items-start gap-3">
                {/* Logo Upload / Drag-and-Drop Area */}
                <div
                  onDragOver={(e) => {
                    e.preventDefault()
                    setIsDragging(true)
                  ...
                  className={`group relative flex h-12 w-12 shrink-0 cursor-pointer items-center justify-center overflow-hidden rounded-xl border transition-all ${
                    logoPreview
                      ? 'border-[#ff6b4a]/40 bg-[#181a22]'
                      : isDragging
                      ? 'border-[#ff6b4a] bg-[#ff6b4a]/10 scale-105'
                      : 'border-dashed border-[#353b4b] bg-[#141720] hover:border-[#ff6b4a]/60 hover:bg-[#181a24]'
                  }`}
                ...
                >
                  {logoPreview ? (
                    ...
                    <svg
                      className="h-5 w-5 text-[#8e95a5] group-hover:text-[#ff6b4a] transition-colors"
                      viewBox="0 0 24 24"
                      fill="none"
                      stroke="currentColor"
                      strokeWidth="1.75"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-xl border border-[#262a36] bg-[#141720] px-4 py-2.5 pr-11 text-sm text-[#f8fafc] placeholder-[#5a6275] outline-none focus:border-[#ff6b4a] focus:ring-2 focus:ring-[#ff6b4a]/20 transition-all"
                />
                <button
                  type="button"
              ...
              {/* Multi-Segment Animated Strength Meter */}
